...
class ScrapedDataAPITests(APITestCase):
    ...
    def test_filter_scraped_data(self):
        ScrapedData.objects.create(title='Test Job 1', description='Description 1', location='Location 1')
        ScrapedData.objects.create(title='Test Job 2', description='Description 2', location='Location 2')
    ...
    def test_pagination_scraped_data(self):
        for i in range(25):
            ScrapedData.objects.create(title=f'Test Job {i}', description=f'Description {i}')
