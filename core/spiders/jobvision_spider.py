        ...
        if script_text:
            ...
            if job_data:
                ...
                if is_expired == False:
                    ...
                    if location_data:
                        city = (
                            location_data.get("city", {}).get("titleFa", "N/A")
                            if location_data.get("city")
                            else "N/A"
                        )
                        region = (
                            location_data.get("region", {}).get("titleFa", "N/A")
                    ...
                    minimum_work_experience = job_data.get(
                        "scoreOfWorkExperienceInJobCategory", {}
                    ).get("expectedValue", "N/A")
                    salary_data = job_data.get("salary")
                    salary = salary_data.get("titleFa", "N/A") if salary_data else "N/A"
                    job_classification = ", ".join(
                        [
                            category.get("titleFa", "N/A")
                            for category in job_data.get("jobCategories", [])
                        ]
                    )
                    military_service_status_required = job_data.get(
                    ...
                    skills = ", ".join(
                        [
                            f"{skill.get('software', {}).get('titleFa', 'N/A')} ({skill.get('skill', {}).get('titleFa', 'N/A')})"
